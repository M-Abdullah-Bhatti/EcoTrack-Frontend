...
export const food = [
  ...
  },
  {
    text: "Tomatoes",
    label: "tomatoes",
    icon: <MaterialIcons name="food-bank" size={24} color="white" />,
  },
  {
